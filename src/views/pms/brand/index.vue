    ...
    <div class="app-container">
        <el-card style="margin-bottom: 20px;" :body-style="{ 'padding-bottom': '2px' }">
            <el-form :inline="true" size="mini">
                ...
                <el-form-item label="首字母">
                    <el-input v-model="listQuery.firstLetter" placeholder="请输入"></el-input>
                </el-form-item>
                <el-form-item>
            ...
            <el-table ref="list" :data="list" style="width: 100%" border>
                ...
                <el-table-column label="logo" width="120" align="center">
                    <template slot-scope="scope">
                        <el-image fit="contain" style="width: 40px; height: 40px" :src="scope.row.logo"></el-image>
                    </template>
                </el-table-column>
        ...
        <el-dialog :title="isEditing ? '编辑' : '新增'" :visible.sync="dialogVisible" width="45%">
            <el-form :model="formData" label-width="80px">
                ...
                <el-form-item label="首字母">
                    <el-input v-model="formData.firstLetter"></el-input>
                </el-form-item>
                <el-form-item label="logo">
                    <el-input v-model="formData.logo"></el-input>
                </el-form-item>
                <el-form-item label="品牌故事">
                    <el-input v-model="formData.brandStory" type="textarea" :rows="2"></el-input>
                </el-form-item>
            </el-form>
...
<script>
import { getPagination, save, update, del } from "@/api/pms/brand";
